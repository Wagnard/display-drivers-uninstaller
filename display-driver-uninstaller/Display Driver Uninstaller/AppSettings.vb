...
#Region "Public Properties"
		...
		Public Property RemoveQualcommCP As Boolean
			Get
				Return CBool(GetValue(m_remQualcommCP))
			End Get
			Set(value As Boolean)
				SetValue(m_remQualcommCP, value)
			End Set
		End Property

		Public Property RemoveQualcommExt As Boolean
			Get
				Return CBool(GetValue(m_remQualcommExt))
			End Get
			Set(value As Boolean)
		...
		Public Property RemoveEnduranceGaming As Boolean
			Get
				Return CBool(GetValue(m_remEnduranceGaming))
			End Get
			Set(value As Boolean)
				SetValue(m_remEnduranceGaming, value)
			End Set
		End Property
		...
		Public Property RemoveIntelExt As Boolean
			Get
				Return CBool(GetValue(m_remIntelExt))
			End Get
			Set(value As Boolean)
				SetValue(m_remIntelExt, value)
			End Set
		End Property
						...
						Dim settings As New XmlWriterSettings With
					 {
					   ...
					   .ConformanceLevel = ConformanceLevel.Document
						...
						With writer
							...
							.WriteElementString("RemoveIntelExt", RemoveIntelExt.ToString())
					   ...
					   .ConformanceLevel = ConformanceLevel.Document
						...
						For Each KvP As KeyValuePair(Of String, String) In props
							Select Case KvP.Key.ToLower()
                                ...
                                Case "removequalcommcp"
									RemoveQualcommCP = Boolean.Parse(KvP.Value)
								...
								Case "removeintelext"
									RemoveIntelExt = Boolean.Parse(KvP.Value)
