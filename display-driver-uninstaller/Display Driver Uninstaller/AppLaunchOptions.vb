...
Namespace Display_Driver_Uninstaller
	...
	Public Class AppLaunchOptions
        ...
        Public Property RemoveQualcommNpu As Boolean = False
		...
		Public Property RemoveIntelExt As Boolean = False
			...
			If args IsNot Nothing AndAlso args.Length > 0 Then
				...
				For Each Argument As String In args
					Select Case True
                        ...
                        Case StrContainsAny(Argument, True, "-RemoveQualcommNpu") : RemoveQualcommNpu = True
						...
						Case StrContainsAny(Argument, True, "-RemoveIntelExt") : RemoveIntelExt = True
