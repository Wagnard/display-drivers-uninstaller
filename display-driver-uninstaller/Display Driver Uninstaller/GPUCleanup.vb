...
child.ToLower.Equals("oneapp_igcc") Then
        ...
        Private Sub RemoveQualcommInstallerRecords(packages As String(), config As ThreadSettings)
            ...
            Dim isMatch As Func(Of String, String, Boolean) = Function(key As String, name As String) Not String.IsNullOrWhiteSpace(name) AndAlso StrContainsAny(name, True, packages)
            CleanupEngine.RemoveUninstallEntries(CleanupEngine.UninstallKey, isMatch, CleanupEngine.UninstallDependencies.ByProviderValue, False, config)
            CleanupEngine.RemoveUninstallEntries(CleanupEngine.UninstallKeyWow, isMatch, CleanupEngine.UninstallDependencies.ByProviderValue, False, config)
        End Sub
