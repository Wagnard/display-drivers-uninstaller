...
Namespace Display_Driver_Uninstaller
	...
	Public Class CleanupEngine
		...
		Private Sub RemoveAppx1809(ByVal AppxToRemove As String)
						...
						If package IsNot Nothing Then
							...
							If StrContainsAny(package.Id.FullName, True, AppxToRemove) Then
								...
								If win10_1809 AndAlso CanDeprovisionPackageForAllUsersAsync() Then
									deploymentOperation = packageManager.DeprovisionPackageForAllUsersAsync(packageIdFamilyName)  'Only avail since Win 10 (1809)
		...
		Public Sub RemoveAppx(ByVal appxToRemove As String)
			If CanDeprovisionPackageForAllUsersAsync() Then
				RemoveAppx1809(appxToRemove)
				Return
			End If
			RemoveAppxPre1809(appxToRemove)
		End Sub

		Private Sub RemoveAppxPre1809(ByVal AppxToRemove As String)
			Dim ServiceInstaller As New ServiceInstaller
			Dim win10 As Boolean = FrmMain.IsWindows10
			Dim win10_1809 As Boolean = FrmMain.IsWindows10_1809
			Dim WasRemoved As Boolean = False
