...
Section -AdditionalIcons
  ...
  CreateShortCut "$SMPROGRAMS\Display Driver Uninstaller\$(STR_01).lnk" "$INSTDIR\${PRODUCT_NAME}.url"
  CreateShortCut "$SMPROGRAMS\Display Driver Uninstaller\$(STR_02).lnk" "$INSTDIR\uninst.exe"
SectionEnd
...
Section Uninstall
  ...
  Delete "$SMPROGRAMS\Display Driver Uninstaller\$(STR_01).lnk"
  Delete "$SMPROGRAMS\Display Driver Uninstaller\$(STR_02).lnk"
