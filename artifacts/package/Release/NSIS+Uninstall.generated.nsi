...
!define PRODUCT_VERSION         "18.1.4.3"
...
!define SOURCE_PATH "C:\\Users\\drago\\Documents\\display-drivers-uninstaller\\artifacts\\package\\Release"
...
LangString STR_03 ${LANG_ITALIAN}  "$(^Name) ? stato correttamente rimosso dal computer."
...
LangString STR_02 ${LANG_FRENCH} "D?sinstaller ${PRODUCT_NAME}"
LangString STR_03 ${LANG_FRENCH} "$(^Name) a ?t? supprim? avec succ?s de votre ordinateur."
LangString STR_04 ${LANG_FRENCH} "?tes-vous s?r de vouloir compl?tement supprimer $(^Name) et tous ses composants ?"
LangString STR_UNINST_TITLE ${LANG_FRENCH} "Options de d?sinstallation"
LangString STR_UNINST_SUBTITLE ${LANG_FRENCH} "Choisissez des options de nettoyage suppl?mentaires"
LangString STR_UNINST_TEXT ${LANG_FRENCH} "Vous ?tes sur le point de d?sinstaller ${PRODUCT_NAME}. Veuillez choisir les options suppl?mentaires ci-dessous:"
LangString STR_UNINST_REMOVELOGS ${LANG_FRENCH} "Supprimer les fichiers journaux"
LangString STR_UNINST_REMOVESETTINGS ${LANG_FRENCH} "Supprimer le fichier de param?tres"

; Simplified Chinese
LangString STR_01 ${LANG_SIMPCHINESE} "?? ${PRODUCT_NAME}"
LangString STR_02 ${LANG_SIMPCHINESE} "?? ${PRODUCT_NAME}"
LangString STR_03 ${LANG_SIMPCHINESE} "$(^Name) ????????????"
LangString STR_04 ${LANG_SIMPCHINESE} "???????? $(^Name) ????????"
LangString STR_UNINST_TITLE ${LANG_SIMPCHINESE} "????"
LangString STR_UNINST_SUBTITLE ${LANG_SIMPCHINESE} "?????????"
LangString STR_UNINST_TEXT ${LANG_SIMPCHINESE} "????? ${PRODUCT_NAME}??????????????"
LangString STR_UNINST_REMOVELOGS ${LANG_SIMPCHINESE} "??????"
LangString STR_UNINST_REMOVESETTINGS ${LANG_SIMPCHINESE} "??????"

; Traditional Chinese
LangString STR_01 ${LANG_TRADCHINESE} "?? ${PRODUCT_NAME}"
LangString STR_02 ${LANG_TRADCHINESE} "?? ${PRODUCT_NAME}"
LangString STR_03 ${LANG_TRADCHINESE} "$(^Name) ????????????"
LangString STR_04 ${LANG_TRADCHINESE} "???????? $(^Name) ????????"
LangString STR_UNINST_TITLE ${LANG_TRADCHINESE} "????"
LangString STR_UNINST_SUBTITLE ${LANG_TRADCHINESE} "?????????"
LangString STR_UNINST_TEXT ${LANG_TRADCHINESE} "????? ${PRODUCT_NAME}??????????????"
LangString STR_UNINST_REMOVELOGS ${LANG_TRADCHINESE} "??????"
LangString STR_UNINST_REMOVESETTINGS ${LANG_TRADCHINESE} "??????"
...
LangString STR_04 ${LANG_GERMAN}  "Sind Sie sicher, dass Sie $(^Name) und alle Komponenten vollst?ndig entfernen m?chten?"
LangString STR_UNINST_TITLE ${LANG_GERMAN} "Deinstallationsoptionen"
LangString STR_UNINST_SUBTITLE ${LANG_GERMAN} "W?hlen Sie zus?tzliche Bereinigungsoptionen"
LangString STR_UNINST_TEXT ${LANG_GERMAN} "Sie sind dabei, ${PRODUCT_NAME} zu deinstallieren. Bitte w?hlen Sie unten zus?tzliche Optionen:"
...
LangString STR_04 ${LANG_SPANISH}  "?Est? seguro de que desea eliminar completamente $(^Name) y todos sus componentes?"
LangString STR_UNINST_TITLE ${LANG_SPANISH} "Opciones de desinstalaci?n"
LangString STR_UNINST_SUBTITLE ${LANG_SPANISH} "Elija opciones adicionales de limpieza"
LangString STR_UNINST_TEXT ${LANG_SPANISH} "Est? a punto de desinstalar ${PRODUCT_NAME}. Elija cualquier opci?n adicional a continuaci?n:"
LangString STR_UNINST_REMOVELOGS ${LANG_SPANISH} "Eliminar archivos de registro"
LangString STR_UNINST_REMOVESETTINGS ${LANG_SPANISH} "Eliminar archivo de configuraci?n"

; Japanese
LangString STR_01 ${LANG_JAPANESE}  "?????? ${PRODUCT_NAME}"
LangString STR_02 ${LANG_JAPANESE}  "${PRODUCT_NAME} ???????????"
LangString STR_03 ${LANG_JAPANESE}  "$(^Name) ????????????????????"
LangString STR_04 ${LANG_JAPANESE}  "??? $(^Name) ?????????????????????????"
LangString STR_UNINST_TITLE ${LANG_JAPANESE} "?????????????"
LangString STR_UNINST_SUBTITLE ${LANG_JAPANESE} "????????????????????????"
LangString STR_UNINST_TEXT ${LANG_JAPANESE} "${PRODUCT_NAME} ???????????????????????????????????????"
LangString STR_UNINST_REMOVELOGS ${LANG_JAPANESE} "???????????"
LangString STR_UNINST_REMOVESETTINGS ${LANG_JAPANESE} "???????????"

; Polski
LangString STR_01 ${LANG_POLISH}  "Strona ${PRODUCT_NAME}"
LangString STR_02 ${LANG_POLISH}  "Odinstaluj ${PRODUCT_NAME}"
LangString STR_03 ${LANG_POLISH}  "$(^Name) zosta? pomy?lnie usuni?ty z komputera."
LangString STR_04 ${LANG_POLISH}  "Czy na pewno chcesz usun?? $(^Name) i wszystkie jego sk?adniki?"
...
LangString STR_UNINST_TEXT ${LANG_POLISH} "Zamierzasz odinstalowa? ${PRODUCT_NAME}. Wybierz dodatkowe opcje poni?ej:"
LangString STR_UNINST_REMOVELOGS ${LANG_POLISH} "Usu? pliki dziennika"
LangString STR_UNINST_REMOVESETTINGS ${LANG_POLISH} "Usu? plik ustawie?"
